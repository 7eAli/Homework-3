...
* git clone "адрес_репозитория" - копирует внешний репозиторий на используемый ПК
...
4. Отправить (git push) ваш локальный репозитьрий в удалённый (на GitHub), при этом, возможно, вам нужно будет авторизоваться на удалённом репозитории
